...
Forestry provides a beautiful editing experience, similar to a Headless CMS, and it creates content in Markdown, committing the changes directly into my [GitHub](https://github.com/fcongson) repository. As a bonus, there are no additional dependencies to using Forestry. My code continued to read the content from Markdown. Forestry provided an elegant workflow that fit my needs.