...
published: true
excerpt: >-
  When I began thinking about how I would rebuild my website, I always thought I
  would use a Headless CMS. The idea of having a dedicated place to create and
  manage content was familiar since I was coming from WordPress. As I was
  transitioning to the idea of building with the Jamstack, a Headless CMS seemed
  to fit the API portion of the JAM. So began my journey of finding the right
  Headless CMS...
_template: posts
---
