...
alt_text: Early logo concepts for Lagom UI represented by shapes
excerpt: 'The word "Lagom," which means "just the right amount," really spoke to me when I was naming my design system. I wanted to lean into the idea and only build what my use cases required...'
---
